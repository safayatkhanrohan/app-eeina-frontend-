const LockLamin = () => {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M3.75 11.25H20.25" stroke="white" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M3.75 14.25H20.25" stroke="white" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M3.75 17.25H20.25" stroke="white" strokeLinecap="round" strokeLinejoin="round" />
      <path
