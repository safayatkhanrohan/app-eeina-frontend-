...
const PaymentFailed = () => {
  ...
  const message = searchParams.get('message') || 'Something went wrong with your payment.';
    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8 flex justify-center items-center">
      <Card className="w-full max-w-lg shadow-xl border-red-100">
        <CardHeader className="flex flex-col items-center text-center pb-2">
          ...
          <p className="text-gray-500 mt-2">We couldn't process your payment. Please try again.</p>
        </CardHeader>
        ...
        <CardFooter className="flex flex-col sm:flex-row gap-3 justify-center">
          ...
          >
            <ArrowLeft className="mr-2 w-4 h-4" /> Choose Plan
          </Button>
          <Button
